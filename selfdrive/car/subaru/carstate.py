...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    if self.car_fingerprint in [CAR.FORESTER_PREGLOBAL, CAR.LEGACY_PREGLOBAL, CAR.LEGACY_PREGLOBAL_2018, CAR.LEVORG_PREGLOBAL, CAR.WRX_PREGLOBAL] and cp.vl["Dash_State"]["Units"] == 0:
      ret.cruiseState.speed *= CV.MPH_TO_KPH
    # EDM Global: mph = 1, 2; All Outback: mph = 1, UDM Forester: mph = 7
    elif self.car_fingerprint not in [CAR.FORESTER_PREGLOBAL, CAR.LEGACY_PREGLOBAL, CAR.LEGACY_PREGLOBAL_2018, CAR.LEVORG_PREGLOBAL, CAR.WRX_PREGLOBAL] and cp.vl["Dash_State"]["Units"] in [1, 2, 7]:
      ret.cruiseState.speed *= CV.MPH_TO_KPH
