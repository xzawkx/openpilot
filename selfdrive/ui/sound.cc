...
static std::map<AudibleAlert, std::pair<const char *, int>> sound_map {
    {AudibleAlert::CHIME_DISENGAGE, {SOUND_CHIME_DISENGAGE, 0}},
    {AudibleAlert::CHIME_ENGAGE, {SOUND_CHIME_ENGAGE, 0}},
    {AudibleAlert::CHIME_WARNING1, {SOUND_CHIME_WARNING1, 0}},
    {AudibleAlert::CHIME_WARNING2, {SOUND_CHIME_WARNING2, 0}},
    {AudibleAlert::CHIME_WARNING2_REPEAT, {SOUND_CHIME_WARNING2_REPEAT, 3}},
    {AudibleAlert::CHIME_WARNING_REPEAT, {SOUND_CHIME_WARNING_REPEAT, 3}},
    {AudibleAlert::CHIME_ERROR, {SOUND_CHIME_ERROR, 0}},
    {AudibleAlert::CHIME_PROMPT, {SOUND_CHIME_PROMPT, 0}}};
